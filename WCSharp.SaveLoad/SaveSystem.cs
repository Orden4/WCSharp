...
{
	/// <summary>
	/// System capable of saving (simple) C# data structures on a players local files to create save files that can be loaded at a later date/map.
	/// </summary>
	public class SaveSystem
	{
		...
		/// <summary>
		/// The Base64 provider that the SaveSystem uses to encode save files.
		/// </summary>
		public static Base64 Base64 { get; set; } = new Base64();
		...
		/// <summary>
		/// Delegate that gets invoked when a save is loaded.
		/// </summary>
