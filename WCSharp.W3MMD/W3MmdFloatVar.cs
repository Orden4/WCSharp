...
{
	/// <summary>
	/// Controls a W3MMD variable of type <see cref="W3MmdVariableType.Float"/>.
	/// </summary>
	public class W3MmdFloatVar : IW3MmdVar
	{
		/// <inheritdoc/>
		public string Name { get; }
		/// <inheritdoc/>
		public W3MmdVariableType VariableType => W3MmdVariableType.Float;
		/// <inheritdoc/>
		...
		public W3MmdFloatVar(string name, W3MmdGoalType goalType, W3MmdSuggestionType suggestionType)
		{
		...
		/// </summary>
		public void Set(player player, float value)
		{
		...
		/// </summary>
		public void Subtract(player player, float value)
		{
