...
```csharp
public RollingBuff(WCSharp.Api.unit caster, WCSharp.Api.unit target);
```
#### Parameters

<a name='WCSharp.Buffs.RollingBuff_T_.RollingBuff(WCSharp.Api.unit,WCSharp.Api.unit).caster'></a>

`caster` [WCSharp.Api.unit](https://docs.microsoft.com/en-us/dotnet/api/WCSharp.Api.unit 'WCSharp.Api.unit')

<a name='WCSharp.Buffs.RollingBuff_T_.RollingBuff(WCSharp.Api.unit,WCSharp.Api.unit).target'></a>
