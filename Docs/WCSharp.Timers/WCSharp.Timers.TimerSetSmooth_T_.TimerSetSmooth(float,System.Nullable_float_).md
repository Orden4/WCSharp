...
## TimerSetSmooth\(float, Nullable\<float\>\) Constructor

Creates a new timer set with the given parameters\.

```csharp
public TimerSetSmooth(float timeout, System.Nullable<float> rootTimeout=null);
```
#### Parameters

<a name='WCSharp.Timers.TimerSetSmooth_T_.TimerSetSmooth(float,System.Nullable_float_).timeout'></a>
...
<a name='WCSharp.Timers.TimerSetSmooth_T_.TimerSetSmooth(float,System.Nullable_float_).rootTimeout'></a>
