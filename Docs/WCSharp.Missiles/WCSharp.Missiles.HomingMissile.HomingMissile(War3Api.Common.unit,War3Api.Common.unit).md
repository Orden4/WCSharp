...
```csharp
public HomingMissile(War3Api.Common.unit caster, War3Api.Common.unit target);
```
#### Parameters

<a name='WCSharp.Missiles.HomingMissile.HomingMissile(War3Api.Common.unit,War3Api.Common.unit).caster'></a>

`caster` [War3Api.Common.unit](https://docs.microsoft.com/en-us/dotnet/api/War3Api.Common.unit 'War3Api.Common.unit')

<a name='WCSharp.Missiles.HomingMissile.HomingMissile(War3Api.Common.unit,War3Api.Common.unit).target'></a>
