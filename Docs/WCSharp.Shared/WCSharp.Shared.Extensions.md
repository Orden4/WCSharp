...
| [SpecializedExtensions](WCSharp.Shared.Extensions.SpecializedExtensions.md 'WCSharp\.Shared\.Extensions\.SpecializedExtensions') | Contains a number of methods that are specialised for lua to improve performance\.   It is strongly recommended that you do not use these. |
