...
namespace WCSharp.Api
{
	...
	public class leaderboard : agent, IDisposable
	{
		...
		/// @CSharpLua.Template = "LeaderboardHasPlayerItem({this}, {0})"
		public extern bool ContainsPlayerItem(player player);
		/// @CSharpLua.Template = "LeaderboardGetPlayerIndex({this}, {0})"
		public extern int GetPlayerIndex(player player);
